            ...
            <div className="mt-20 px-6 pt-6 md:px-12 bg-white dark:bg-black  text-black dark:text-white">
                <div className="flex flex-col md:flex-row md:justify-evenly font-raleway my-8 animate-fadeIn">
                    ...
                    <span className="md:w-1/2 w-full font-medium text-2xl py-5 px-0 md:px-5 md:py-3">
                        ...
                        <span className='flex gap-x-2'>
                            <Button label={translation.code} hasLink={true} url={project.github} nextLink={false} svg={<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" className='fill-current mr-1' viewBox="0 0 16 16">
                                <path d="M10.478 1.647a.5.5 0 1 0-.956-.294l-4 13a.5.5 0 0 0 .956.294l4-13zM4.854 4.146a.5.5 0 0 1 0 .708L1.707 8l3.147 3.146a.5.5 0 0 1-.708.708l-3.5-3.5a.5.5 0 0 1 0-.708l3.5-3.5a.5.5 0 0 1 .708 0zm6.292 0a.5.5 0 0 0 0 .708L14.293 8l-3.147 3.146a.5.5 0 0 0 .708.708l3.5-3.5a.5.5 0 0 0 0-.708l-3.5-3.5a.5.5 0 0 0-.708 0z" />
                            </svg>} />
                            <Button label={translation.demo} hasLink={true} url={project.demo} nextLink={false} svg={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className='fill-current mr-1' viewBox="0 0 16 16">
                ...
                <div className="grid md:grid-cols-2 md:grid-rows-2 md:gap-x-3 grid-rows-auto gap-y-4 font-montserrat">
                    ...
                    <div className="md:ml-12 md:mr-8">
                        ...
                        <span className="text-gray-800 dark:text-gray-300 ">{project.partner}</span>
                    </div>
                    <div className="md:ml-48 md:mr-8" style={{ lineBreak: 'strict' }}>
                    ...
                    <div className="md:ml-12 md:mr-8">
                        <h3 className="uppercase font-semibold tracking-wider text-xl mb-3">{translation.type}</h3>
                        <span className="text-gray-800 dark:text-gray-300"
                ...
                <Divider />
                <div className="grid md:grid-cols-5 md:grid-rows-3 md:gap-x-3 gap-y-4 md:gap-y-1 grid-rows-auto font-montserrat">
                    <div className="md:ml-48 md:mr-8 col-span-2 uppercase font-semibold tracking-wider text-xl" >
                        {translation.problem}
                    </div>
                    <div className="col-span-3 md:mr-16 text-justify">{project.problem}</div>
                    <div className="md:ml-48 md:mr-8 col-span-2 uppercase font-semibold tracking-wider text-xl" >
